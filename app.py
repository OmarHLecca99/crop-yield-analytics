...
# =====================================================
# SESSION STATE (control de carga duplicada)
# =====================================================
if "last_uploaded_filename" not in st.session_state:
    st.session_state.last_uploaded_filename = None

# =====================================================
# FUNCIÓN UTIL: obtener último CSV cargado
# =====================================================
...
with tab_experiments:
    ...
    # ============================
    # CONFIG MONGODB (del código antiguo)
    # ============================

    MONGO_URI = "mongodb+srv://omarhlecca_db_user:MtkyPn3dgu2v3gFp@cropyieldcluster.rndwxww.mongodb.net/?appName=CropYieldCluster"
    DB_NAME = "crop_yield"
